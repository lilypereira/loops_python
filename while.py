...
termination_number = -1  # Specifying a number that, if entered, will not be included in calculations
...
while True:
    ...
    if user_input != termination_number:
    ...
    elif user_input == termination_number:
        break
